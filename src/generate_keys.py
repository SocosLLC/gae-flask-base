...
From Flask AppEngine Template by kamalgill
https://github.com/kamalgill/flask-appengine-template/blob/master/src/application/generate_keys.py
...
Outputs secret_keys.py file in application/
...
file_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'application', file_name)
